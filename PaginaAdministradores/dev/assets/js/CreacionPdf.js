document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("Dia3").addEventListener("click", function () {
        generatePDF('03/06/2023', 'Día 3 de junio', [
            ...
            [6, '11:15', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 2, 7210, 1370, 8580],
    ...
    document.getElementById("Dia4").addEventListener("click", function () {
        generatePDF('04/06/2023', 'Día 4 de junio', [
            ...
            [3, '10:28', 'Antigrasas Mrdd. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
            [4, '10:36', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100],
            ...
            [11, '12:37', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 2, 4286, 814, 5100],
    ...
    document.getElementById("Dia5").addEventListener("click", function () {
        generatePDF('05/06/2023', 'Día 5 de junio', [
            ...
            [12, '12:30', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100]
        ], Trabajador1); // Pasar el objeto contact correspondiente al día 2
    });
    document.getElementById("Dia6").addEventListener("click", function () {
        generatePDF('06/06/2023', 'Día 6 de junio', [
            ...
            [5, '10:59', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 1, 2143, 407, 2550],
    ...
    document.getElementById("Dia7").addEventListener("click", function () {
        generatePDF('07/06/2023', 'Día 7 de junio', [
            ...
            [12, '12:46', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100]
        ], Trabajador1); // Pasar el objeto contact correspondiente al día 2
    });
    document.getElementById("Dia8").addEventListener("click", function () {
        generatePDF('08/06/2023', 'Día 8 de junio', [
            ...
            [11, '12:32', 'Lavalozas Ecológico Fuzol', 'Artículo Limpieza', 1588, 1, 1588, 302, 1890],
            [12, '12:36', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 1, 3605, 685, 4290]
        ], Trabajador2); // Pasar el objeto contact correspondiente al día 2
    });
    document.getElementById("Dia9").addEventListener("click", function () {
        generatePDF('09/06/2023', 'Día 9 de junio', [
            ...
            [11, '12:15', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
    ...
    document.getElementById("Dia10").addEventListener("click", function () {
        generatePDF('10/06/2023', 'Día 10 de junio', [
            ...
            [7, '11:35', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 2, 7210, 1370, 8580],
    ...
    document.getElementById("Dia11").addEventListener("click", function () {
        generatePDF('11/06/2023', 'Día 11 de junio', [
            [1, '09:15', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 1, 3605, 685, 4290],
            [2, '10:25', 'Detergente líquido Ariel', 'Artículo Limpieza', 3781.6, 3, 11345, 2156, 13500],
            [3, '10:45', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 2, 7210, 1370, 8580],
            [4, '11:15', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
            [5, '11:59', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 1, 2143, 407, 2550],
            [6, '12:10', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100],
            [7, '12:17', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 2, 4286, 814, 5100],
            [8, '12:25', 'Lavalozas Ecológico Fuzol', 'Artículo Limpieza', 1588.3, 3, 4765, 905, 5670],
            [9, '12:29', 'Antigrasas Mrdd. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
            [10, '12:32', 'Lavalozas Ecológico Fuzol', 'Artículo Limpieza', 1588, 1, 1588, 302, 1890],
            [11, '12:36', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100],
            [12, '12:50', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 1, 2143, 407, 2550]
        ], Trabajador1); // Pasar el objeto contact correspondiente al día 2
    });
    document.getElementById("Dia12").addEventListener("click", function () {
        generatePDF('12/06/2023', 'Día 12 de junio', [
            [1, '09:32', 'Lavalozas Ecológico Fuzol', 'Artículo Limpieza', 1588, 1, 1588, 302, 1890],
            [2, '09:59', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 1, 2143, 407, 2550],
            [3, '10:00', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 1, 2143, 407, 2550],
            [4, '10:07', 'Limpiador de piso Clorox', 'Artículo Hogar', 2143, 2, 4286, 814, 5100],
            [5, '10:15', 'Lavalozas Ecológico Fuzol', 'Artículo Limpieza', 1588.3, 3, 4765, 905, 5670],
            [6, '10:28', 'Antigrasas Mrdd. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
            [7, '10:46', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100],
            [8, '11:15', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 1, 2983, 567, 3550],
            [9, '11:30', 'Antigrasas Mr. Músculo', 'Artículo Limpieza', 2983, 2, 5966, 1134, 7100],
            [10, '11:45', 'Detergente líquido Ariel', 'Artículo Limpieza', 3781.6, 3, 11345, 2156, 13500],
            [11, '12:15', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 1, 3605, 685, 4290],
            [12, '12:45', 'Antigrasas Multiuso KH-7', 'Artículo Limpieza', 3605, 2, 7210, 1370, 8580]
        ], Trabajador2); // Pasar el objeto contact correspondiente al día 2
    });
